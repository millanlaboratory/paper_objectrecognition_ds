...
\begin{figure}[!t]
    ...
    \caption{Visualization of the protocol.
        ...
        Right: schematic drawing of a road segment with the target cue, boards and finish line. Note that the boards are invisible until they are approached to a close distance.
