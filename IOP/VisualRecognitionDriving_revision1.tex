...
due to the strong early evoked components after the subsequent fixation
onset rather than due to the difference in later cognitive components.
Therefore, these classifiers may indirectly rely on the difference 
between the target and non-targets dwell times.
However, this was not the case as the simulated online
performance of the EEG-based decoders did not exhibit 
the improvement similar to the classification models based on dwell time. 
%Also, a combination of the two sources of 
%information (EEG and dwell time) did not lead to significant
%improvement as compared to EEG alone.
