...
The process of attentional orienting under a such distance constraint on popping up of the board ensured 
...
\begin{figure}[!t]
    ...
    \caption{Visualization of the protocol.
        ...
        Right: schematic drawing of a road segment with the target cue, boards and finish line.
    }
\label{fig:setup}
\end{figure}
...
In both phases, we included empty roads where subjects have no additional tasks 
...
Finally, in this study, our focus was on detecting the neural correlates of object recognition.
