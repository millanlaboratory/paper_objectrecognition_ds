...
%, and other experimental settings made unnecessary to utilize eye-tracking 
%as it would have been the case on more natural setups
...
\center
    ...
    %\includegraphics[trim={0cm 0cm 1.5cm 0cm},clip,height=0.65\columnwidth]{../images/offline/Epochs_GA_chCz_Saggregate_objrec_subjects_popuponline_s1.pdf}%
    %\includegraphics[trim={0cm 0cm 1.5cm 0cm},clip,height=0.65\columnwidth]{../images/online/Epochs_GA_chCz_Saggregate_objrec_subjects_popuponline_s1.pdf}%
    %\includegraphics[trim={0cm 0cm 0cm 0cm},clip,height=0.65\columnwidth]{../images/online/Colorbar.pdf}
